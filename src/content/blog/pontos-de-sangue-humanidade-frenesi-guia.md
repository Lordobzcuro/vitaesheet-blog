---
title: 'Pontos de Sangue, Humanidade e Frenesi: O Guia que Faltava no Seu RPG Vampiro'
description: 'Você sabe que seu personagem tem 10 pontos de sangue. Mas sabe o que acontece quando chega a zero? Este guia destrincha as mecânicas que ninguém explica direito.'
pubDate: 'Mar 16 2026 20:00'
heroImage: '../../assets/hero-sangue-humanidade.jpg'
tags: ['Guia', 'Mecânicas']
---
...
- Comece pelo básico: [Como criar sua ficha de RPG Vampiro](/blog/guia-completo-fichas-vampiro-v20)
- Entenda os poderes: [Guia de Disciplinas do nível 1 ao 5](/blog/guia-disciplinas-poderes-vampiricos-explicados)
- Dê vida ao personagem: [Como criar um vampiro com história de verdade](/blog/como-criar-personagem-rpg-vampiro-com-historia)
...
<summary>Pontos de sangue se regeneram sozinhos?</summary>
<p>Não. A única forma de recuperar sangue é se alimentando — de mortais, animais (menos eficiente) ou outros vampiros (perigoso — pode criar Laço de Sangue). Não existe regeneração passiva. Se acabou, você precisa caçar.</p>
</details>

<details class="faq-item">
<summary>Posso recuperar Humanidade perdida?</summary>
<p>Sim, mas é difícil e caro. Exige gasto de XP (geralmente o dobro do custo normal de atributos) e, mais importante, exige ações genuínas de compaixão e empatia dentro da narrativa. O narrador decide quando o personagem demonstrou mudança real suficiente para justificar a recuperação.</p>
</details>

<details class="faq-item">
<summary>O que acontece se eu entrar em Frenesi durante uma cena social importante?</summary>
<p>Consequências reais. Se você entrar em Frenesi na frente do Príncipe, do Bispo, ou em um Elísio, o dano político pode ser pior que qualquer ferimento físico. É por isso que vampiros com Autocontrole baixo evitam Cortes — e por que provocar o Frenesi de um rival é uma tática política clássica.</p>
</details>

<details class="faq-item">
<summary>Meu personagem pode "resistir" ao Frenesi sem teste?</summary>
<p>Não. Quando o gatilho acontece, o teste é obrigatório. Pontos de Força de Vontade podem ser gastos para ganhar sucessos automáticos no teste (não para evitá-lo). Alguns clãs têm mais dificuldade que outros — certos vampiros são mecanicamente mais propensos ao Frenesi.</p>
</details>
